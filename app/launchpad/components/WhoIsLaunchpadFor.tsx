    ...
    return (
        <section className="py-24 px-6 max-w-[1200px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-t border-l border-slate-200">
                <div className="md:col-span-2 p-10 lg:p-12 border-b border-r border-slate-200 flex flex-col justify-center bg-slate-50/50">
                ...
                {[
                    ...
                    <div key={i} className="p-10 lg:p-12 border-b border-r border-slate-200 bg-white hover:bg-[#F4F6FB] transition-colors group">
