...
export default function LaunchpadHero() {
    return (
        <section className="relative w-full bg-slate-50 pt-28 pb-8 md:pt-32 md:pb-10 border-b border-slate-200 overflow-hidden">
            <div className="absolute inset-0 z-0 bg-white">
                ...
                <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-slate-100 to-transparent z-10"></div>
                ...
                <div className="w-full flex flex-col md:flex-row justify-between items-center h-full gap-10">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-slate-800 tracking-tight leading-[1.1] mb-6">
                            Turn Your Idea Into a Working <span className="font-bold text-slate-900 text-brand">  MVP in Just 15 Days.</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-4">
                            <button className="bg-brand text-white px-8 py-3 rounded-full text-sm font-medium hover:bg-brand-dark transition-all shadow-lg flex items-center justify-center gap-2">
                                Apply for Launchpad <ArrowRight className="w-4 h-4" />
                            </button>
                            <button className="bg-white text-slate-800 px-8 py-3 rounded-full text-sm font-medium hover:bg-slate-50 transition-all shadow-md border border-slate-200 flex items-center justify-center gap-2">
                                Book a Founder Call
                            </button>
                        </div>
                        
                        <div className="absolute -left-8 top-16 w-2.5 h-2.5 bg-brand/30 rounded-full hidden lg:block"></div>
                        <div className="absolute left-64 -bottom-10 w-1.5 h-1.5 bg-blue-400/50 rounded-full hidden lg:block"></div>
                    </motion.div>
