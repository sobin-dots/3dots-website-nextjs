                ...
                <div className="lg:w-2/3 flex flex-col pt-4">
                    {[
                        ...
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className="group flex flex-col sm:flex-row gap-6 sm:gap-10 py-10 border-b border-slate-200 last:border-0 hover:-translate-y-1 transition-transform duration-500"
                        >
