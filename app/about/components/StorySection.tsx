    ...
    return (
        <section className="py-24 px-6 relative bg-white border-b border-slate-100">
            ...
            <div className="max-w-[1400px] mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    <div className="w-full h-[500px] rounded-4xl overflow-hidden group shadow-2xl relative">
                        <Image
                    ...
                    <div className="absolute -bottom-8 -right-8 w-64 bg-white p-8 rounded-4xl shadow-xl border border-slate-100 hidden md:block">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-light tracking-tight mb-8 text-slate-800">
                        How 3Dots <span className="font-medium">Started?</span>
                    </h2>
