        ...
        <section className="relative w-full bg-slate-50 pt-24 pb-6 border-b border-slate-200 overflow-hidden mb-16">
            ...
            <div className="max-w-[1200px] mx-auto px-6 relative z-20 w-full min-h-[120px] flex items-center">
                <div className="w-full flex justify-between items-center h-full">
                    ...
                    >
                        <span className="bg-brand text-white text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-sm mb-3">Our Mission</span>
                        <h3 className="text-sm font-medium text-slate-800 mb-2 leading-snug">Empowering Founders</h3>
                        <p className="text-xs font-light text-slate-500 mb-4 line-clamp-2">We build scalable software specifically designed for high-growth tech startups.</p>
