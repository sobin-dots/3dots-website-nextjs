                ...
                <div className="w-full flex justify-between items-center h-full">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-slate-800 tracking-tight leading-[1.1]">
                            Let&apos;s Build <span className="font-bold text-slate-900">Together.</span>
                        </h1>
                        <div className="absolute -left-8 top-16 w-2.5 h-2.5 bg-brand/30 rounded-full"></div>
                        <div className="absolute left-32 -bottom-6 w-1.5 h-1.5 bg-brand-400/50 rounded-full"></div>
                    </motion.div>
                    ...
                    >
                        <span className="bg-brand text-white text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-sm mb-3">Support</span>
                        <h3 className="text-sm font-medium text-slate-800 mb-2 leading-snug">Average Response</h3>
                        <p className="text-xs font-light text-slate-500 mb-4 line-clamp-2">Get back to you within 24 hours. Send us an inquiry about your next big project.</p>
