                        ...
                        <div className="md:w-1/2 flex flex-col md:pt-12">
                            ...
                            <div className="flex flex-wrap gap-x-8 gap-y-4 items-center">
                                ...
                                <div className="ml-auto">
                                    <button className="flex items-center justify-center w-14 h-14 rounded-full border border-slate-200 text-slate-400 group-hover:bg-brand group-hover:border-brand group-hover:text-white group-hover:scale-110 transition-all duration-500 shadow-sm">
