...
export default function LaunchpadSection() {
    return (
        <section id="launchpad" className="py-24 px-6 bg-brand text-white text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-white tracking-normal leading-[1.3] md:leading-[1.3] mb-12">
                    Launch your startup faster. <br className="hidden sm:block" />
