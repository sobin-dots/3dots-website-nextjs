        ...
        {/* // <section id="about" className="py-24 px-6 max-w-[1400px] mx-auto relative pt-10"> */}
            ...
            {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-slate-800 tracking-normal leading-[1.2] md:leading-[1.2] mb-10 font-semibold">Who We Are</h2>
                    ...
                    <Link href="/about" className=" text-brand border border-brand/30 px-8 py-3 rounded-full text-[15px]  hover:bg-brand hover:text-white transition-all inline-flex items-center gap-2">
                ...
                >
                    ...
                    <div className="absolute bottom-[10%] right-[5%] lg:right-[25%] w-28 h-28 rounded-full border-4 border-white shadow-xl overflow-hidden z-10 transition-transform hover:scale-110">
